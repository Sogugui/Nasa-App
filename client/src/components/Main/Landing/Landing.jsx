        ...
        <div className='font-poppins hidden lg:flex justify-between px-24 py-4 items-center select-none'>
                <section>
                    ...
                    <section className='flex gap-14 text-l items-center'>
                        ...
                        <div className="mx-8">
                            <h4 className="text-black text-center font-semibold text-l underline my-6 transition hover:text-amber-500">Create your own landing!</h4>
                            <button onClick={routeChange} className="w-full px-2 py-1 bg-slate-400/80 hover:bg-amber-500  text-slate-100 rounded-lg" type="submit">Create</button>
                        </div>
                    </section>
            </div>
